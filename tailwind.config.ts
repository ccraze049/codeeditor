  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // IDE specific colors
        ide: {
          'bg-primary': 'var(--ide-bg-primary)',
          'bg-secondary': 'var(--ide-bg-secondary)',
          'bg-tertiary': 'var(--ide-bg-tertiary)',
          'text-primary': 'var(--ide-text-primary)',
          'text-secondary': 'var(--ide-text-secondary)',
          'text-accent': 'var(--ide-text-accent)',
          'border': 'var(--ide-border)',
          'success': 'var(--ide-success)',
          'warning': 'var(--ide-warning)',
          'error': 'var(--ide-error)',
          'purple': 'var(--ide-purple)',
          'orange': 'var(--ide-orange)',
          'yellow': 'var(--ide-yellow)',
          'green': 'var(--ide-green)',
          'blue': 'var(--ide-blue)',
          'red': 'var(--ide-red)',
        },
